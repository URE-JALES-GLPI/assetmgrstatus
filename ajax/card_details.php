    ...
    if ($type === 'ticket') {
        ...
        echo json_encode([
            ...
            'data'=>[
                ...
                'has_receiver' => !empty($transfer['assinatura_image']),
                'has_tecnico' => !empty($transfer['assinatura_tecnico_image']),
                'is_assinado' => \GlpiPlugin\Assetmgrstatus\Transfer::isAssinado($transfer),
                'precisa' => \GlpiPlugin\Assetmgrstatus\Transfer::precisaAssinatura($transfer),
